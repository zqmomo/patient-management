...
<div class="nav-navicon admin-main admin-sidebar">
    ...
    <div class="sideMenu">
      ...
      <h3 class="am-icon-cart-plus"> 手术管理</h3>
      <ul>
...
<div class="admin-biaogelist">
    <div class="listbiaoti am-cf">
      ...
      <dl class="am-icon-home" style="float: right;"> 当前位置： 首页 > <a href="#">病人管理</a></dl>
  ...
  try
  {
    ...
    while(rs.next())
    {
       ...
       u.setBinglinum(rs.getString("binglinum"));
       u.setName(rs.getString("name"));
       u.setTtime(rs.getString("ttime"));
    ...
    for(int i=0;i<userList.size();i++)
    {
       ...
       //输出
       out.print("<tr>");
       out.print("<td>"+userList.get(i).getid()+"</td><td>"+userList.get(i).getBinglinum()+"</td><td>"+userList.get(i).getName()+"</td><td>"+userList.get(i).getTtime()+"</td><td>"
       +userList.get(i).getYishengname()+"</td>");
       out.print("</tr>");
    }
