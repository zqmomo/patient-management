...
<div class="nav-navicon admin-main admin-sidebar">
    ...
    <div class="sideMenu">
      ...
      <h3 class="am-icon-users on">医护管理</h3>
      <ul>
        <li>查询医护信息 </li>
...
<div class="admin-biaogelist">
    <div class="listbiaoti am-cf">
      ...
      <dl class="am-icon-home" style="float: right;"> 当前位置： 首页 > <a href="#">医护管理</a></dl>
  ...
  try
  {
    ...
    while(rs.next())
    {
       ...
       //一行一行读取对象状态
       u.setYishengnum(rs.getString("yishengnum"));
    ...
    for(int i=0;i<userList.size();i++)
    {
       ...
       //输出
       out.print("<tr>");
       out.print("<td>"+userList.get(i).getYishengnum()+"</td><td>"+userList.get(i).getYishengname()+"</td><td>"+userList.get(i).getSex()+"</td><td>"+userList.get(i).getKeshi()+"</td>");
       out.print("</tr>");
    }
